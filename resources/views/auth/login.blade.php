                            ...
                            <div class="p-5">
                                ...
                                <form method="POST" action="{{ route('login') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user @error('username') is-invalid @enderror" name="username" placeholder="{{ __('Username or E-Mail Address') }}" value="{{ old('username') }}" required autofocus>
                                    </div>
