...
<html>
<head>
    <title>Maintenance Report #VMR-0JWTOS</title>
    <style>
        /* PDF Styling */
        body {
...
<body>
    ...
    <div class="container">
        <!-- Maintenance Details -->
        <div class="section">
            <h3 style="margin-bottom: 15px;">Maintenance Information</h3>
            
            <div class="grid-2col">
                <div>
                    <div class="data-item">
                        <span class="label">Maintenance Code:</span>
                        <span class="value">VMR-0JWTOS</span>
                    </div>
                    <div class="data-item">
        ...
        <!-- Vehicle Details -->
        <div class="section">
            <h3 style="margin-bottom: 15px;">Tools Information</h3>
